...
function MultipleChoiceQuiz({ questions, apiBaseUrl, authApiUrl, lessonFilename }: { questions: QuizQuestion[], apiBaseUrl?: string, authApiUrl?: string, lessonFilename?: string }) {
...
export default function Quiz({ questions, story, language = 'chinese', apiBaseUrl, authApiUrl, lessonFilename }: QuizProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-8">
                {(activeType === 'all' || activeType === 'mcq') && grouped.mcq.length > 0 && (
                    <MultipleChoiceQuiz questions={grouped.mcq} apiBaseUrl={apiBaseUrl} authApiUrl={authApiUrl} lessonFilename={lessonFilename} />
                )}
